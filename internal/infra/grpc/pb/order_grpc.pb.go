...
type OrderServiceClient interface {
	...
	ListOrders(ctx context.Context, in *BlankRequest, opts ...grpc.CallOption) (*OrderList, error)
}
...
func (c *orderServiceClient) ListOrders(ctx context.Context, in *BlankRequest, opts ...grpc.CallOption) (*OrderList, error) {
	out := new(OrderList)
...
type OrderServiceServer interface {
	...
	ListOrders(context.Context, *BlankRequest) (*OrderList, error)
...
func (UnimplementedOrderServiceServer) ListOrders(context.Context, *BlankRequest) (*OrderList, error) {
